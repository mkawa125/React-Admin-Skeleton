                ...
                <div className="md:mt-12 md:w-64 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                    <ul className="list-reset  text-center md:text-left">
                        <li className="mr-0 flex-1">
                            <Link to={"/"} className="block py-2 md:py-3 pl-2 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-pink-500">
                        ...
                        <li className="mr-0 flex-1">
                            <Link to={'users'} className="block py-2 md:py-3 pl-2 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500">
                        ...
                        <li className="mr-0 flex-1">
                            <Link to={"/"} className="block bg-gray-700 py-2 md:py-3 pl-2 align-middle text-white no-underline hover:text-white border-l-2 border-blue-600">
                        ...
                        <li className="mr-0 flex-1">
                            <Link to={"/orders"} className="block py-2 md:py-3 pl-2 md:pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-red-500">
