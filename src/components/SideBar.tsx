                    ...
                    <ul>
                        ...
                        <li className="relative">
                            ...
                            <i className="fa fa-list-alt"></i>
                                <span className="ml-4">Product categories </span>
                            </NavLink>
                        </li>
                        ...
                        <li className="relative">
                            <NavLink to={'/products'} className={({ isActive }) => (isActive ? activeClasses : inActiveClasses)}>
                            <i className="fa fa-list-alt"></i>
                                <span className="ml-4">Product Collections </span>
                            </NavLink>
                        </li>

                        <li className="relative">
                            <NavLink to={'/product-attribute-sets'} className={({ isActive }) => (isActive ? activeClasses : inActiveClasses)}>
                            <i className="fa fa-th-list"></i>
                                <span className="ml-4">Product Attribute Sets </span>
                            </NavLink>
                        </li>
